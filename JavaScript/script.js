...
async function getsongs(folder) {
    ...
    // making the songlist in left library section 
    let songul = document.querySelector(".songlist").getElementsByTagName("ul")[0]

    //    we blank the inner html of the ul to add event listner on cards 
    songul.innerHTML = "";
            ...
            cardcontainer.innerHTML = cardcontainer.innerHTML + `  <div data-folder="${folder}" class="card">
                        <div class="play">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24.96 24.96">
                                ...
                                <circle cx="12.48" cy="12.48" r="12" fill="#90ee90" /> <!-- Light green -->
